\documentclass[10pt, twocolumn, hidelinks]{article}
\usepackage[a4paper, total={17cm, 23cm}, left=2cm, top=2cm]{geometry}
...
\author{Daniel Fajmon \href{mailto:xfajmo05@stud.fit.vutbr.cz}{(xfajmo05@stud.fit.vutbr.cz)}}
\date{}
...
Skládá se z odstavců, obvykle začínajících zarážkou, nejde-li o~první odstavec za nadpisem. Mohou ale být sázeny ibez zarážky -- rozhodující je celková grafická úprava. Odstavec končí východovou řádkou. Věty nesmějí začínat číslicí.
...
\begin{quotation}
{\fontfamily{phv}\selectfont{\largeČím více druhů}}, \textsc{řezů}, {\tiny velikostí}, {\color{cyan}barev} písma \underline{a~jiných efektů} použijeme, tím \emph{\large profesionálněji} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen}! 
\end{quotation}
...
Druhou odlišností je pravidlo pro sázení konců řád\-ků. V české sazbě by řádek neměl končit osamocenou jednopísmennou předložkou nebo spojkou. Spojkou \uv{a}~končit může pouze při sazbě do šířky 25 liter. Abychom \LaTeX u zabránili v sázení osamocených před\-lo\-žek, spojujeme je s následujícím slovem \emph{nezlomitelnou mezerou}. Tu sázíme pomocí znaku \verb|~| (vlnka, tilda). 
...
Balíček {\bfseries fontenc} slouží ke korektnímu kódovaní zna\-ků s diakritikou, aby bylo možno v textu vyhledávat a~kopírovat z něj.
